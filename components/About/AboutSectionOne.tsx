      ...
      <div className="container">
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Secure & Confidential" />
                    <List text="Customizable Workflows" />
                    <List text="Mobile Access" />
                  </div>

                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Real-time Notifications" />
                    <List text="Data-Driven Insights" />
                    <List text="Transparent charges" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full px-4 lg:w-1/2">
              <div
                className="wow fadeInUp relative mx-auto aspect-[30/22] max-w-[650px] lg:mr-0"
                data-wow-delay=".2s"
              >
                <Image
